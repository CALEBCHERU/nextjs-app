...
// C:\Users\khale\Documents\projects\nextjs-app\src\app\api\formDb\submit.ts
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    // Create a new object that converts age to number
    const submissionData = {
      ...form,
      age: Number(form.age),  // 👈 Ensure age is a number
    };

    console.log("Data set to the api", submissionData);

    const res = await fetch('http://localhost:3000/api/formDb/postgres', {
      method: 'POST',
